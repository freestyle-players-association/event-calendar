                    ...
                    <form method="POST"
                        ...
                        <div class="flex gap-2">
                            <div class="mt-4">
                                ...
                                <x-date-input id="start_date" name="start_date" x-model="startDate" value="{{ $event->start_date }}"
                                              required/>
                            </div>
                            <div class="mt-4">
                                <x-input-label for="end_date" :value="__('End Date')"/>
                                <x-date-input id="end_date" name="end_date" x-model="endDate" value="{{ $event->end_date }}" required/>
                            </div>
                        </div>
                        <div class="mt-4">
